...
The primary background estimate is the instantaneous surface velocity in an annulus around each eddy. The workflow also calculates a thickness-weighted 0–500 m annulus velocity, monthly climatological surface and 0–500 m velocities, and exact count-weighted full-archive surface and 0–500 m means.
